namespace Checkout
{
    public class ApiUrls
    {
        ...
        public static string ShoppingList
            = _customersApiUri ?? (_customersApiUri = string.Concat(AppSettings.BaseApiUri, "/ShoppingList"));

        public static string ShoppingListItem
            = _customerApiUri ?? (_customerApiUri = string.Concat(AppSettings.BaseApiUri, "/ShoppingList/{0}"));

        public static string ShoppingListItemDelete
            = _customerApiUri ?? (_customerApiUri = string.Concat(AppSettings.BaseApiUri, "/ShoppingList/delete{0}"));
    }
}